          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div ref={heroContainerRef} style={{ position: 'relative' }}>
              ...
              <motion.button
                ...
                className="px-10 py-5 bg-gradient-to-r from-violet-600 to-purple-600 text-white text-base font-bold rounded-xl hover:from-violet-500 hover:to-purple-500 transition-all inline-flex items-center gap-3 shadow-lg shadow-violet-500/50"
              >
            ...
            <div className="relative h-[600px] hidden lg:block">
              ...
              <motion.div
                ...
                className="absolute top-0 right-0 w-72 bg-gradient-to-br from-cyan-500/10 to-blue-500/10 backdrop-blur-xl border border-cyan-500/30 rounded-2xl p-6 shadow-xl shadow-cyan-500/10"
              >
              ...
              <motion.div
                ...
                className="absolute top-48 right-12 w-64 bg-gradient-to-br from-purple-500/10 to-pink-500/10 backdrop-blur-xl border border-purple-500/30 rounded-2xl p-6 shadow-xl shadow-purple-500/10"
              >
                ...
                <div className="mt-4 flex gap-1">
                  {[80, 60, 90, 40, 70, 95, 85].map((height, i) => (
                    <div key={i} className="flex-1 bg-zinc-800 rounded-full overflow-hidden h-20">
                      <div className="bg-gradient-to-t from-purple-500 to-pink-500 rounded-full transition-all" style={{ height: `${height}%` }}></div>
                    </div>
                  ))}
                </div>
              </motion.div>
              ...
              <motion.div
                ...
                className="absolute bottom-0 right-24 w-56 bg-gradient-to-br from-orange-500/10 to-red-500/10 backdrop-blur-xl border border-orange-500/30 rounded-2xl p-5 shadow-xl shadow-orange-500/10"
              >
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-10 h-10 bg-gradient-to-br from-orange-400 to-red-500 rounded-lg flex items-center justify-center shadow-lg shadow-orange-500/50">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="text-center border-r border-zinc-900 last:border-r-0">
              <div className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent mb-3">100%</div>
            ...
            <div className="text-center border-r border-zinc-900 last:border-r-0">
              <div className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-purple-400 to-pink-500 bg-clip-text text-transparent mb-3">3</div>
            ...
            <div className="text-center border-r border-zinc-900 last:border-r-0">
              <div className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-green-400 to-emerald-500 bg-clip-text text-transparent mb-3">&lt;2s</div>
            ...
            <div className="text-center">
              <div className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-orange-400 to-red-500 bg-clip-text text-transparent mb-3">0</div>
              ...
              >
                <div className="flex items-start justify-between mb-6">
                  <div className={`w-14 h-14 rounded-xl flex items-center justify-center shadow-lg ${
                    index === 0 ? 'bg-gradient-to-br from-cyan-400 to-blue-500 shadow-cyan-500/50' :
                    index === 1 ? 'bg-gradient-to-br from-purple-400 to-violet-600 shadow-purple-500/50' :
                    index === 2 ? 'bg-gradient-to-br from-orange-400 to-amber-500 shadow-orange-500/50' :
                    index === 3 ? 'bg-gradient-to-br from-pink-400 to-rose-500 shadow-pink-500/50' :
                    index === 4 ? 'bg-gradient-to-br from-green-400 to-emerald-500 shadow-green-500/50' :
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={onCreateTaskClick}
              className="px-12 py-6 bg-gradient-to-r from-violet-600 to-purple-600 text-white text-lg font-bold rounded-xl hover:from-violet-500 hover:to-purple-500 transition-all inline-flex items-center gap-3 shadow-xl shadow-violet-500/50"
            >
